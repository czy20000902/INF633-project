...
public class animal_bugs : MonoBehaviour
{
    [Header("Goal")]
    ...
    private void TrackHead()
    {
        ...
        // Draw a line from the headBone to the goal for visualization
        Debug.DrawLine(headBone.position, goal.position, Color.blue);
    }
